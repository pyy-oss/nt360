...
function parsePnl(wb) {
  ...
  for (const r of rows) {
    ...
    byFp.set(safeId(fp), {
      ...
      designation: String(valLabel(r, keys, "description du projet", "description projet", "désignation", "designation", "objet", "affaire", "projet", "libellé", "libelle", "intitulé", "intitule", "description", "descriptif", "nom du projet", "nom projet", "nom de l'affaire", "sujet", "titre", "prestation", "mission", "nature", "solution", "offre", "opportunité", "opportunite") || "").trim(),
